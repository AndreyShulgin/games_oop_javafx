...
public class Logic3T {
    ...
    private boolean isWin(Predicate<Figure3T> predicate) {
        return this.fillBy(predicate, 0, 0, 1, 0) ||
                ...
                this.fillBy(predicate, this.table.length - 1,this.table.length - 1, -1, 0) ||
                this.fillBy(predicate, 1,0, 0, 1) ||
                this.fillBy(predicate, this.table.length - 1,1, -1, 0);
    }
